    ...
    <div className="bg-gray-700/50 border border-blue-500/30 rounded-lg overflow-hidden">
      <div className="p-4">
        ...
        <p className="text-sm font-semibold text-gray-300 mb-3">
          Gemini suggests the following changes:
        </p>
        <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
          {changes.map((change, index) => (
            <div
              ...
              onMouseEnter={() =>
                onHighlightCell(
                  change.targetCellId !== "new" ? change.targetCellId : null
                )
              }
      ...
      <div className="bg-gray-800/50 p-2 flex justify-end space-x-2">
        {!reviewDecision ? (
          ...
          <div
            className="flex items-center space-x-2 px-3 py-1.5 text-sm text-green-400"
          ...
          <div
            className="flex items-center space-x-2 px-3 py-1.5 text-sm text-red-400"
